...
{
    public partial class uctlAddItem_Invoice : UserControl
    {
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            if (selItem != null)
            {
                if (txtQty.Text.Trim().Length > 0)
                {
                    ...
                    if (txtPrice.Text.Trim() != "" && cUtils.ConvertToDouble(txtPrice.Text.Trim()) > 0)
                        details.Price = cUtils.ConvertToDouble(txtPrice.Text.Trim());
                    else
                    {
                        cUtils.ShowMessageInformation("Please provide Item Price", "Add Item Invoice");
                        return;
                    }
                ...
                {
                    cUtils.ShowMessageInformation("Please provide quantity", "Add Item Invoice");
                    return;
                }
            }
        }
